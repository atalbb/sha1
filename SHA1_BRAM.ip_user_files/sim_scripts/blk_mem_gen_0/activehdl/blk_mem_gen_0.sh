...
#
# Generated by Vivado on Thu Jul 20 08:11:31 -0400 2017
...
copy_setup_file()
{
  ...
  if [[ ($1 != "") ]]; then
    ...
    lib_map_path="C:/College/Thesis/VivadoProjects/SHA1_BRAM_10/SHA1_BRAM.cache/compile_simlib/activehdl"
  fi

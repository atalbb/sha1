...
HD_PWD='C:/College/Thesis/VivadoProjects/SHA1_core/SHA1_core.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log Final_hash.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source Final_hash.tcl -notrace

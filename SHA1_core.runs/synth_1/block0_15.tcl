...
read_verilog -library xil_defaultlib C:/College/Thesis/VivadoProjects/SHA1_core/SHA1_core.srcs/sources_1/new/block0_15.v
foreach dcp [get_files -quiet -all *.dcp] {
  set_property used_in_implementation false $dcp
}

synth_design -top block0_15 -part xc7a100tcsg324-1


write_checkpoint -force -noxdef block0_15.dcp

catch { report_utilization -file block0_15_utilization_synth.rpt -pb block0_15_utilization_synth.pb }

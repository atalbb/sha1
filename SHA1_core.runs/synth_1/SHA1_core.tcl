...
read_verilog -library xil_defaultlib C:/College/Thesis/VivadoProjects/sha1_core/SHA1_core.srcs/sources_1/new/SHA1_core.v
foreach dcp [get_files -quiet -all *.dcp] {
  set_property used_in_implementation false $dcp
}

synth_design -top SHA1_core -part xc7a100tcsg324-1


write_checkpoint -force -noxdef SHA1_core.dcp

catch { report_utilization -file SHA1_core_utilization_synth.rpt -pb SHA1_core_utilization_synth.pb }

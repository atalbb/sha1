...
HD_PWD='C:/College/Thesis/VivadoProjects/SHA1_core/SHA1_core.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Final_hash.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Final_hash.tcl
